...
public class TileColorProvider {
    ...
    {
        return Random.ColorHSV(); //TODO: Fine tune the inputs to this function to get the desired  A E S T H E T I C.
    }

    private void initColorPair()
    {
        baseColor = targetColor != null ? targetColor : getRandomColor();
